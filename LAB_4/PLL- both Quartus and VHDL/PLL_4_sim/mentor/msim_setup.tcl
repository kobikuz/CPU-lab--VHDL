...
# ----------------------------------------
# If PLL_4 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 842 win32 2024.07.09.20:14:59
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_4.vho"
}
